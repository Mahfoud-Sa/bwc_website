  ...
  return (
    <div className="flex w-full h-full">
      <div className="flex-1 w-[50%] h-full flex justify-center items-center relative">
        <div className="absolute w-[30%] h-[65%] bg-[#E4C189] -z-[10] top-[20px] left-[10px]">

        </div>
        <div className="w-[80%] h-[80%]">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d634.0013811751327!2d49.12067139261173!3d14.532088105942686!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3de8e7a7ef4a3659%3A0x805ca06a13dfebf5!2z2YXYudmH2K8g2KjYsdmK2YXZitmI2YUgTUlJIFByZW1pdW0!5e0!3m2!1sar!2s!4v1719749824322!5m2!1sar!2s" width="600" height="450" className="border-0 w-full h-full"  loading="lazy" ></iframe>
        </div>
      </div>
