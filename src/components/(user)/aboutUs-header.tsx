...
export default function AboutUsHeader() {
  ...
  return (
    <>
      <div>
        {isMobileScreen && (
          <div className="w-full h-[90vh] grid grid-cols-1 gap-2 px-2">
            ...
            {dir === "ltr" ? (
              <div className="w-full h-[100vh] grid grid-cols-1 gap-2 px-4">
                <div className="h-[70vh] w-full relative flex justify-center items-center ">
                  <div className="absolute md:w-[25%] md:h-[55%] bg-[#E4C189] -z-[10] md:top-[25px]  md:left-[60px]"></div>
                  ...
                  <div className="absolute flex justify-center  md:rounded-md items-center w-[45%] h-[45%] bg-[#fff] z-[10]  bottom-[0px] right-0">
                    <img
                      src={Image1}
                ...
                <div className="h-[90vh] w-full bg-black">a</div>
              </div>
            ) : (
              <div className="w-full h-[100vh] grid grid-cols-1 gap-2 px-4">
                <div className="h-[70vh] w-full relative flex justify-center items-center ">
                  <div className="absolute md:w-[25%] md:h-[55%] bg-[#E4C189] -z-[10] md:top-[25px]  md:right-[60px]"></div>
                  <div className="w-[80%] h-[80%] bg-white relative">
                    <img
                      src={Image1}
                      className="object-cover w-full h-full"
                  ...
                  <div className="absolute flex justify-center  md:rounded-md items-center w-[45%] h-[45%] bg-[#fff] z-[10]  bottom-[0px] left-0">
                    <img
                      src={Image1}
                      className=" w-[92%] h-[88%] round"
                      alt=""
