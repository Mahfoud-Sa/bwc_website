          ...
          <>
            {dir === "ltr" ? (
              ...
              <div className="h-[70vh] w-full relative flex justify-center items-center ">
                <div className="absolute sm:w-[25%] sm:h-[55%] bg-[#E4C189] -z-[10] sm:top-[20px]  sm:left-[40px]"></div>
                ...
                <div className=" pl-4 ">
                  ...
                  <div className="grid grid-cols-3 gap-2 mt-6">
                    <div className=" flex justify-start items-center">
                      <span className=" w-[40%] h-[100%] rounded-full bg-gradient-to-r from-[#997740] to-[#CCA972] flex justify-center items-center mr-2">
                        <img src={partnership} className="w-[100%] h-[80%]" alt="" />
                      </span>
                      <p className="text-xl">{t("our_mission")}</p>
                    </div>
                    <div className=" flex justify-start items-center">
                      <span className=" w-[40%] h-[100%] rounded-full bg-gradient-to-r from-[#997740] to-[#CCA972] flex justify-center items-center mr-2 ml-2">
                    ...
                    <div className=" flex justify-start items-center">
                      <span className=" w-[40%] h-[100%] rounded-full bg-gradient-to-r from-[#997740] to-[#CCA972] flex justify-center items-center mr-2">
                        <img src={chartBullish} className="w-[80%] h-[80%]" alt="" />
                      </span>
                      <p className="text-xl">{t("our_goals")}</p>
                    </div>
              ...
              <div className="h-full w-full">
                <div className=" pl-4 ">
                  ...
                  <div className="grid grid-cols-3 gap-2 mt-6">
                    <div className=" flex justify-start items-center">
                      <span className=" w-[40%] h-[100%] rounded-full bg-gradient-to-r from-[#997740] to-[#CCA972] flex justify-center items-center ml-2">
                        <img src={partnership} className="w-[100%] h-[80%]" alt="" />
                      </span>
                      <p className="text-xl">{t("our_mission")}</p>
                    </div>
                    <div className=" flex justify-start items-center">
                      <span className=" w-[40%] h-[100%] rounded-full bg-gradient-to-r from-[#997740] to-[#CCA972] flex justify-center items-center ml-2 mr-2">
                        <img src={golas} className="w-[80%] h-[80%]" alt="" />
                      </span>
                      <p className="text-xl">{t("our_goals")}</p>
                    </div>
